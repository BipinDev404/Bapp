  ...
  createProject(data: {
    ...
    const project: Project = {
      ...
      config: {
        ...
        enableMicrophone: data.config?.enableMicrophone ?? false,
        enableDownloads: data.config?.enableDownloads ?? true,
        enablePopups: data.config?.enablePopups ?? true,
        enableNotifications: data.config?.enableNotifications ?? false,
        popupBehavior: data.config?.popupBehavior || 'external_browser',
